...
const ansButton = (e) => {
    ...
    if (questionCount == question.length) {
        ...
        if(successCount === 3){
        document.getElementById("answer1").innerHTML = ("あなたは将来<br>ヘルシーまっちょさんになれるかも!");
        document.getElementById("countDown").style.visibility = "hidden";
        document.getElementById("ansArea").style.visibility = "hidden";
        ...
        document.getElementById("answer3").innerHTML = ("あなたは将来<br>愛され♡ぷにるんずになります");
        document.getElementById("countDown").style.visibility = "hidden";
        document.getElementById("ansArea").style.visibility = "hidden";
        ...
        document.getElementById("answer4").innerHTML = ("あなたは将来<br>病気になっちゃいます");
        document.getElementById("countDown").style.visibility = "hidden";
        document.getElementById("ansArea").style.visibility = "hidden";
